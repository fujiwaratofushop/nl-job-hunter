...
I am writing to express my interest in the [JOB_TITLE] position at [COMPANY_NAME]. With over 7 years of experience building production AI systems and cloud-native platforms — most recently as a Senior Software Engineer (SDE3 / Associate Vice President) at JPMorgan Chase Asset & Wealth Management — I bring deep expertise in Python, AWS, AI-native system design, and end-to-end ML platform engineering, along with expertise in React and TypeScript. I am actively pursuing relocation to Europe.

At JPMorgan, I work on Connect OS, an internal AI-native platform serving 10,000+ developers, designers, and advisors. I have architected MCP servers giving LLMs RAG-based access to our design system and component APIs, cutting development and migration time by roughly 70%. I also built Connect Studio, a multi-persona AI platform supporting design-to-code, story-to-code, and Jira-to-code workflows, reducing time-to-review from days to seconds. Prior to this, at Aurigo Software Technologies, I led frontend architecture across multiple product lines, built a drag-and-drop workflow builder serving 1,000+ concurrent users via SQS, and designed and built training pipelines for an LLM-powered product on AWS SageMaker. I hold a B.E. in Electrical and Electronics Engineering from BITS Pilani with a Finance minor, and have mentored 10+ engineers.
